            ...
            var table = $('#tableUserGroup').DataTable({
                ...
                { 
                    ...
                    render: function ( data, type, row, meta ) {
                        ...
                        var btnDelete = (<c:out value="${userGroup.id}" /> !== row.id) ? '<a class="btn btn-danger btn-delete" href="" data-toggle="tooltip" data-placement="top" title="<s:message code="button.delete" />"><i class="fa fa-lg fa-trash"></i></a>' : '';
